...
const House = props => {
  ...
  const handleDeleteFavorites = () => {
    Axios.delete(` https://frozen-bayou-05010.herokuapp.com/favorites/${favorite.favoriteId}`)
      .then(response => {
  ...
  const isFavorite = () => {
    Axios.post(' https://frozen-bayou-05010.herokuapp.com/isfavorite', { house_id: id })
      .then(response => {
  ...
  const handleFavorites = () => {
    Axios.post(' https://frozen-bayou-05010.herokuapp.com/favorites', { house_id: id })
      .then(response => {
